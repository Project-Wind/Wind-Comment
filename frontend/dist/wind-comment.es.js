...
const _hoisted_1$3 = ["onSubmit"];
const _hoisted_2$2 = { class: "flex justify-between flex-wrap flex-col sm:flex-row" };
const _hoisted_3$1 = ["placeholder"];
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("button", { class: "block mt-4 py-3 px-5 border border-gray-800 hover:bg-gray-800 hover:text-white font-bold text-sm rounded-lg transition duration-150 ease-in-out" }, "\u63D0\u4EA4", -1);
const _sfc_main$3 = {
  props: {
    comment: Object
  },
  setup(__props) {
    ...
    const getChildComments = inject("getChildComments", void 0);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", {
        class: "w-full",
        onSubmit: withModifiers(postComment, ["prevent"])
      }, [
...
const _hoisted_4 = { class: "font-bold text-sm" };
const _hoisted_5 = { class: "my-1 text-lg" };
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    const visibleReply = inject("visibleReply");
    const toggleReply = inject("toggleReply");
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(Fragment, null, [
        createBaseVNode("div", _hoisted_1$2, [
          ...
          createBaseVNode("div", _hoisted_3, [
            createBaseVNode("div", _hoisted_4, toDisplayString(__props.comment.name), 1),
            createBaseVNode("p", _hoisted_5, toDisplayString(__props.comment.content), 1),
            createBaseVNode("div", _hoisted_6, [
              createBaseVNode("span", _hoisted_7, toDisplayString(__props.comment.date), 1),
              createBaseVNode("button", {
                type: "button",
                onClick: _cache[0] || (_cache[0] = ($event) => unref(toggleReply)(__props.comment.id))
              }, "\u56DE\u590D")
            ])
          ])
        ]),
        unref(visibleReply) === __props.comment.id ? (openBlock(), createBlock(_sfc_main$3, {
          key: 0,
          class: "mt-4",
          comment: __props.comment
        }, null, 8, ["comment"])) : createCommentVNode("", true)
      ], 64);
    };
  }
};
const _hoisted_1$1 = { class: "py-4" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2, [
          createVNode(_sfc_main$2, { comment: __props.comment }, null, 8, ["comment"])
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(childComments.value, (childComment) => {
          return openBlock(), createElementBlock("div", {
            class: "ml-4 sm:ml-[calc(48px+1rem)] my-4",
            key: childComment.id
          }, [
            createVNode(_sfc_main$2, { comment: childComment }, null, 8, ["comment"])
          ]);
        }), 128))
      ]);
    };
...
const _hoisted_1 = { class: "bg-white rounded-xl border border-solid border-[#ddd] shadow shadow-[#ddd] px-8 py-2 divide-y divide-dashed divide-gray-300" };
const _sfc_main = {
  setup(__props) {
    const comments = ref([]);
